        ...
        <TerminalBox title="NOTICE BOARD" variant="heavy">
          ...
          <Collapse in={noticeExpanded}>
            ...
            >
              ...
              <br />
              - Feedback (Top Right), put in bug reports, improvements or feature requests.
              <br />
              - Army support for NRH, AEF and ABS
              <br />
              - Improved embark relationships
              <br />
              - Text export (with autogenerated blinds)
              <br />
              <br />
              - SYSADMIN
